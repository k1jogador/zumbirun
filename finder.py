...
def find (matriz):
    start_node = find_node(matriz, 'Z')
    end_node = find_node(matriz, 'P')
    maze_graph = transform_to_graph(matriz)
    solved_maze = solve_maze(matriz, maze_graph, start_node, end_node)
